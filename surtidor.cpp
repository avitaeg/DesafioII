...
void surtidor::codigo_s() {
    ...
    while (true) {
        cout << "Ingrese el código de la estación (4 dígitos): ";
        cin >> input_codigo;
        ...
        if (codigos_usados.find(input_codigo) != codigos_usados.end()) {
            ...
            cout << "Código de la estación asignado correctamente: " << codigo << endl;
            break; // Salir del bucle
        }
    }
}

// Plantilla para establecer el precio
template <typename T>
void establecer_precio(T& precio) {
    while (true) {
        ...
        if (precio > 0) {
            ...
            cout << "Error: El precio debe ser un número positivo. Inténtelo de nuevo." << endl;
        }
    }
}

// Establece los precios de los combustibles utilizando la plantilla
void surtidor::estbl_precios() {
    cout << "Establezca los precios de los combustibles:" << endl;
    establecer_precio(precio_tipo1);  // Combustible regular
    establecer_precio(precio_tipo2);  // Combustible Premium
    establecer_precio(precio_tipo3);  // Combustible EcoExtra

    cout << "Precios establecidos correctamente." << endl;
    cout << "Combustible regular: " << precio_tipo1 << endl;
    cout << "Combustible Premium: " << precio_tipo2 << endl;
    cout << "Combustible EcoExtra: " << precio_tipo3 << endl;
}
